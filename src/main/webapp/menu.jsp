		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
		      <ul class="nav navbar-nav">		       
		        ...
		        <li><a href="${pageContext.request.contextPath}/download.html"><font color="black"><strong>关于本站</strong></font></a></li>
		        <li><a href="http://www.66super.com/search"><font color="black"><strong>超锅搜索</strong></font></a></li>
		        <li><a href="http://www.66super.com/translate"><font color="black"><strong>超锅翻译</strong></font></a></li>
